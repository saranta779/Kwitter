...
dislike_button = "<button class = 'btn btn-warning' id = "+firebase_message_id+" value = "+like+" onclick = 'updateLike(this.id)'>";
span_with_tag_down = "<span class = 'glyphicon glyphicon-thumbs-down'>Dislike: " + like + "</span> </button> <hr>";
